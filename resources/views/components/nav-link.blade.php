...
$classes = ($active ?? false)
            ? 'inline-flex items-center px-1 pt-1 border-b-2 border-[#22C55E] text-sm font-bold leading-5 text-[#22C55E] focus:outline-none transition duration-150 ease-in-out'
